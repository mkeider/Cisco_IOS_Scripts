...
#################################################################################################
#Script connects to cisco_ios device extracts VRF data, parses with textfsm, then               #
#outputs to .csv "sho_vrf.csv"                                                                  #
#################################################################################################
...
with open('vrf_results.json', 'w') as results_file:
    json.dump(results, results_file, indent=2)


with open('sho_vrf.csv','w', newline='')as new_file:
   fieldnames = ['local_host','default_rd','interfaces','name', 'protocols']
