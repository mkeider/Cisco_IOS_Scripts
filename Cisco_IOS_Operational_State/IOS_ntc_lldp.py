...
#################################################################################################
#Script connects to cisco_ios device extracts lldp neighbor data, parses with textfsm, then     #
#outputs to .csv "lldp_neighbor.csv"                                                           #
#################################################################################################
...
with open('lldp_results.json', 'w') as results_file:
    json.dump(results, results_file, indent=2)


with open('lldp_neighbor.csv','w', newline='')as new_file:
   fieldnames = ['local_host','neighbor','local_interface','neighbor_interface']
